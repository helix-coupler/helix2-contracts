...
interface iNameResolver {
    ...
    function addr2(bytes32 namehash, uint256 coinType) external view returns (bytes memory);
    function pubkey(bytes32 namehash) external view returns (bytes32 x, bytes32 y);
